...
func (ctl *BigModelController) LuoJia(ctx *gin.Context) {
	...
	if !ok {
		prepareOperateLog(ctx, "anonymous", OPERATE_TYPE_SYSTEM, "launch LuoJia bigmodel")
		return
	}
...
func (ctl *BigModelController) LuoJiaUploadPicture(ctx *gin.Context) {
	pl, _, ok := ctl.checkUserApiToken(ctx, false)
	if !ok {
		prepareOperateLog(ctx, "anonymous", OPERATE_TYPE_SYSTEM, "upload picture to LuoJia bigmodel")
		return
	}
...
func (ctl *BigModelController) WuKong(ctx *gin.Context) {
	pl, _, ok := ctl.checkUserApiToken(ctx, false)
	if !ok {
		prepareOperateLog(ctx, "anonymous", OPERATE_TYPE_SYSTEM, "launch wukong bigmodel")
		return
	}
...
func (ctl *BigModelController) WuKongAsync(ctx *gin.Context) {
	pl, _, ok := ctl.checkUserApiToken(ctx, false)
	if !ok {
		prepareOperateLog(ctx, "anonymous", OPERATE_TYPE_SYSTEM, "launch wukong bigmodel task")
		return
	}
...
func (ctl *BigModelController) AddLike(ctx *gin.Context) {
	...
	if !ok {
		prepareOperateLog(ctx, "anonymous", OPERATE_TYPE_SYSTEM, desc)
		return
	}
...
func (ctl *BigModelController) CancelLike(ctx *gin.Context) {
	pl, _, ok := ctl.checkUserApiToken(ctx, false)
	if !ok {
		prepareOperateLog(ctx, "anonymous", OPERATE_TYPE_SYSTEM, "cancel like on wukong picture")
		return
	}
