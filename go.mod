...
require (
	...
	github.com/opensourceways/xihe-inference-evaluate v0.0.0-20240515091021-fe5d1f98f9da
...
require (
	...
	github.com/opensourceways/xihe-grpc-protocol v0.0.0-20231204090636-ed34b5b0415d // indirect
