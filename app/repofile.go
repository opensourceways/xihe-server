...
type RepoFileService interface {
	...
	DownloadRepo(u *UserInfo, repoId string, handle func(io.Reader, int64), n domain.ResourceName) error
}
...
func (s *repoFileService) DownloadRepo(u *UserInfo, repoId string, handle func(io.Reader, int64), n domain.ResourceName) error {
	s.rf.DownloadRepo(u, repoId, handle)
	return s.sender.DailyDownload(u.User, n)
}
